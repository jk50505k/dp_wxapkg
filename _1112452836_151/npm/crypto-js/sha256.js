            ...
            _doProcessBlock: function(e, t) {
                for (var o = this._hash.words, r = o[0], n = o[1], i = o[2], s = o[3], c = o[4], u = o[5], l = o[6], h = o[7], y = 0; y < 64; y++) {
                    if (y < 16) a[y] = 0 | e[t + y]; else {
                        var p = a[y - 15], d = a[y - 2];
                        a[y] = ((p << 25 | p >>> 7) ^ (p << 14 | p >>> 18) ^ p >>> 3) + a[y - 7] + ((d << 15 | d >>> 17) ^ (d << 13 | d >>> 19) ^ d >>> 10) + a[y - 16];
                    }
                    var _ = r & n ^ r & i ^ n & i, m = (r << 30 | r >>> 2) ^ (r << 19 | r >>> 13) ^ (r << 10 | r >>> 22), v = h + ((c << 26 | c >>> 6) ^ (c << 21 | c >>> 11) ^ (c << 7 | c >>> 25)) + (c & u ^ ~c & l) + f[y] + a[y];
                    h = l, l = u, u = c, c = s + v | 0, s = i, i = n, n = r, r = v + (m + _) | 0;
                }
