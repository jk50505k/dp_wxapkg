    ...
    return function(r) {
        ...
        var u = a.SHA3 = n.extend({
            ...
            _doFinalize: function() {
                var o = this._data, t = o.words;
                this._nDataBytes;
                var e = 8 * o.sigBytes, n = 32 * this.blockSize;
                t[e >>> 5] |= 1 << 24 - e % 32, t[(r.ceil((e + 1) / n) * n >>> 5) - 1] |= 128, o.sigBytes = 4 * t.length, 
                this._process();
                for (var h = this._state, a = this.cfg.outputLength / 8, f = [], c = 0; c < a / 8; c++) {
                    var l = h[c], s = l.high, u = l.low;
                    s = 16711935 & (s << 8 | s >>> 24) | 4278255360 & (s << 24 | s >>> 8), u = 16711935 & (u << 8 | u >>> 24) | 4278255360 & (u << 24 | u >>> 8), 
                    f.push(u), f.push(s);
                }
